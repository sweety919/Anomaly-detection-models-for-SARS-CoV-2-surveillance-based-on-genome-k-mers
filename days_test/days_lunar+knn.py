...
def knn_model(train_set,test_set):
    ...
    for country in country_list:
        ...
        for i in range(len(day_file)):
            ...
            if len(train_set_1) == 0:
                ...
                print(i, "+1")
                pred_list_1 = lunar_model(train_set_1, test_set_1)
                ...
                if pred_list_1.tolist().count(1) == 0:
                    ...
                    print(i, "+2")
                    pred_list_2 = knn_model(train_set_2, test_set_2)
        ...
        path2_1 = country+"_0904+lunar+knn.csv"
