...
clade_list = ['19A','19B','20A','20B','20C','20D','20E','20G','20H','20I','20J','21A','21B','21D','21F','21G','21H','21I','21J','21K','21L','21M','22A','22B','22C','22D','22E','22F','23A','23C']
...
month_l = []
for t in Portugal['collection_time'].values.tolist():
    month = t[:7]
    month_l.append(month)
Portugal.insert(3,"collection_month",month_l)
time_clade_l = []
for i in month_all:
    for c in clade_list:
        count_num = len(Portugal.loc[(Portugal["collection_month"]==i)&(Portugal["nextstrain_clade"]==c)])
        time_clade = {}
        time_clade["month"]=i
        time_clade["clade"]=c
...
plt.title('Clade count of Portugal',fontsize=28)  # 字体大小设置为25
...
color_l = ['#8ECFC9','#FFBE7A','#FA7F6F','#82B0D2','#BEB8DC','#E7DAD2','#2878b5','#9ac9db','#f8ac8c','#c82423','#ff8884','#F6CAE5','#96CCCB','#f74d4d','#ffa510','#002c53','#41b7ac','#F27970','#BB9727','#54B345','#32B897','#05B9E2','#8983BF','#C76DA2','#A1A9D0','#F0988C','#B883D4','#9E9E9E','#CFEAF1','#C4A5DE']
...
plt.xticks(xs,month_all,rotation=90)  # 横坐标日期范围及间隔
