...
clade_list = ['19A','19B','20A','20B','20C','20D','20H','20I','20J','21A','21I','21J','21K','21L','22A','22B','22C','22D','22E','22F','23A']
...
plt.title('Clade count of China',fontsize=28)  # 字体大小设置为25
...
color_l = ['#8ECFC9','#FFBE7A','#FA7F6F','#82B0D2','#BEB8DC','#E7DAD2','#f8ac8c','#c82423','#ff8884','#F6CAE5','#F27970','#BB9727','#54B345','#32B897','#8983BF','#C76DA2','#A1A9D0','#F0988C','#B883D4','#9E9E9E','#CFEAF1']
...
# plt.yscale("symlog")
# a=plt.yticks(ticks=np.array([0,1,2,4,6,8,10,20,30,50,100,200,400,600,800,1000,2000,3000,4000,5000]),
#              labels=np.array(['0','1','2','4','6','8','10','20','30','50','100','200','400','600','800','1000','2000','3000','4000','5000']))
plt.yticks(range(0,5000,200))
plt.tick_params(labelsize=18)
leg = plt.legend(ncol=2,prop={'size':24},loc="upper left")
