...
if __name__ == "__main__":
    ...
    ecod_f.to_csv("./step1_result/ecod.csv",index=False)
    ocsvm_f.to_csv("./step1_result/ocsvm.csv", index=False)
    knn_f.to_csv("./step1_result/knn.csv", index=False)
    iforest_f.to_csv("./step1_result/iforest.csv", index=False)
    ae_f.to_csv("./step1_result/ae.csv", index=False)
    lunar_f.to_csv("./step1_result/lunar.csv", index=False)
