...
if __name__=="__main__":
    ...
    for i in range(1,4):
        ...
        print(test_target_1)
        print(i, "+1")
        pred_list_1 = lunar_model(train_set_1, test_set_1, test_target_1)
        ...
        train_set_2 = prepare_input_train_2(train_path)
        print(i, "+2")
        pred_list_2 = lunar_model(train_set_2, test_set_2, test_target_2)
    ...
    whole_metrics_f.to_csv("./stacking_test/lunar+lunar.csv",index=False)
