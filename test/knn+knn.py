...
if __name__ == "__main__":
    ...
    for i in range(0,len(info_file)):
        ...
        if len(train_set_1)==0:
            ...
            print(i, "+1")
            pred_list_1, metric_knn = knn_model(train_set_1, test_set_1, test_target_1)
    ...
    whole_metrics_f.to_csv("./test_knn+knn(n_neighbors=5)0905.csv")
    knn_f = pd.DataFrame(knn_l)
    knn_f.to_csv("./step1_knn(n_neighbors=5,knn+knn)0905.csv")
    print(file)